...
if ($X < 0) { echo "NOTA RECUPERACION: 1435 queda por encima del fisico (inventario aun sin cargar aqui); el residual E2 lo baja al fisico actual y el cierre del 20/08 lo pisa despues.
"; }
