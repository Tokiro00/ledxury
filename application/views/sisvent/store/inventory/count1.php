    	 		...
    	 		<div  id="inventory-print" class="px-6 mx-auto grid">
                    ...
                    <form id="new-inventory-form" action="<?php echo base_url();?>sisvent/store/inventory/storeCount1" method="POST">
                      ...
                      <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md">
                        ...
                        <label class="block flex flex-row gap-5 mt-4 text-sm print:hidden">
                          <button type="button" id="btn-all-inventory" class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 bg-mam-blue-dark text-white rounded-lg focus:outline-none focus:shadow-outline-gray" aria-label="FillAll" onclick="">Agregar Todos</button>
                          <button type="button" onclick="printDiv('Inventario <?= $inventory->idInventory; ?>','inventory-print')"  class="flex items-center justify-between px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-mam-blue-dark border border-transparent rounded-lg active:bg-mam-blue-dark hover:bg-mam-blue-dark focus:outline-none focus:shadow-outline-mam-blue-dark">
                            <span>Imprimir</span>
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z"></path></svg>
                          </button>
                        </label>

                        <label class="block mt-4 text-sm print:hidden">
                          ...
                          <div class="relative text-gray-500 focus-within:text-purple-600">
                            ...
                            <button id="btn-agregar" class="flex items-center justify-between absolute inset-y-0 right-0 px-4 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-mam-blue-dark border border-transparent rounded-r-lg focus:outline-none" type="button" value="" onclick=""/>
                              ...
                              <tbody id="tborders" class="bg-white divide-y">
                                <?php foreach($details as $key => $detail):?>
                                    <tr class="text-gray-700">
                                      ...
                                      <td class="px-4 py-3 print:py-0 text-sm"><input class='form-input quantities' type='number' name='quantities[]' min='0' value='<?php echo $detail->quantity;?>'></td>
