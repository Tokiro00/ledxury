                    ...
                    <form id="new-inventory-form" action="<?php echo base_url();?>sisvent/store/inventory/storeCount2" method="POST">
                      ...
                      <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md">
                        ...
                        <div id="cont" class="block flex flex-row gap-5 my-4 text-sm print:hidden">
                          ...
                          <input type="submit" class="px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-mam-blue-dark border border-transparent rounded-lg active:bg-mam-blue-dark hover:bg-mam-blue-dark focus:outline-none focus:shadow-outline-mam-blue-dark <?php echo $show ?>" value="Guardar">
                        </div>
