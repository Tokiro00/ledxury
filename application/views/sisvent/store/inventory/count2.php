                    ...
                    <form id="new-inventory-form" action="<?php echo base_url();?>sisvent/store/inventory/storeCount2" method="POST">
                      ...
                      <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md">
                        ...
                        <div id="cont" class="block flex flex-row gap-5 my-4 text-sm print:hidden">
                          ...
                          <button type="button" onclick="printDiv('Conteo 2 Inventario <?= $inventory->idInventory; ?>','inventory-print')"  class="flex items-center justify-between px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-mam-blue-petroleo border border-transparent rounded-lg active:bg-mam-blue-petroleo hover:bg-mam-blue-petroleo focus:outline-none focus:shadow-outline-mam-blue-petroleo">
                            <span>Imprimir</span>
