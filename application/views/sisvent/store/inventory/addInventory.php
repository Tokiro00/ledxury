    		...
    		<?php $this->load->view('sisvent/layouts/navbar'); ?>
    	 	<main class="h-full overflow-y-auto">
    	 		<div class="px-6 mx-auto grid">
                    ...
                    <form id="new-inventory-form" action="<?php echo base_url();?>sisvent/store/inventory/storeInventory" method="POST">
                        ...
                        <label class="block mt-4 text-sm">
                          ...
                          <select name="user" class="form-input form-select" required>
                            <?php foreach($users as $user): ?>
                                <option value="<?php echo $user->idUser?>" <?php echo set_select("user",$user->idUser);?>><?php echo $user->name;?></option>
                            <?php endforeach;?>
                          </select>
                        </label>
