    		...
    		<?php $this->load->view('sisvent/layouts/navbar'); ?>
    	 	<main class="h-full overflow-y-auto">
    	 		<div class="px-6 mx-auto grid">
                    ...
                    <form id="new-inventory-form" action="<?php echo base_url();?>sisvent/store/count/update" method="POST">
                      ...
                      <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md">
                        <input class="form-input" type="hidden" name="idCount" value="<?php echo $count->idCount;?>" readonly/>
                        <label class="block mt-4 text-sm">
                          <span class="text-gray-700">
                            Almacén
                          </span>
                          <input type="hidden" name="store" id="store" value="<?php echo $count->storeId;?>"/>
                          <input class="form-input" type="text" value="<?php echo $count->store_name;?>" readonly/>
                        </label>
                              ...
                              <tbody id="tborders" class="bg-white divide-y">
                                <?php if(!empty($products)):?>
                                  <?php foreach($products as $product):?>
                                      ...
                                      <td class='px-4 py-3'><input class="form-input" type="hidden" name="stock[]" value="<?php echo $product->stock;?>" readonly/><input class='form-input' type='text' id='quantities' name='quantities[]' value='<?php echo $product->quantity; ?>'></td>
