    ...
    <div id="bars" class="flex h-screen">
        ...
        <main class="h-full m-auto">
          <div class="px-6 mx-auto grid">
                    ...
                    <div class="mb-4 font-semibold mt-2 text-center">
                    <button onclick="printDiv('Productos Sin Imagen','no-images-prod-print')"  class="flex items-center justify-between px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-mam-blue-petroleo border border-transparent rounded-lg active:bg-mam-blue-petroleo hover:bg-mam-blue-petroleo focus:outline-none focus:shadow-outline-mam-blue-petroleo">
            <span>Imprimir</span>
