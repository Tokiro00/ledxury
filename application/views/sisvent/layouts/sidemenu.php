<div class="py-4 text-gray-300">
  ...
  <!-- ================================================================ -->
    ...
    <li class="relative px-6 py-3">
      <?php if(in_array($thisFile, ['sisvent/admin/financialdashboard/index','sisvent/admin/cashboxes/list','sisvent/admin/cashboxes/add','sisvent/admin/cashboxes/edit','sisvent/admin/cashboxes/view','sisvent/admin/cashmovements/list','sisvent/admin/cashmovements/add','sisvent/admin/cashmovements/transfer','sisvent/admin/cashmovements/view','sisvent/admin/bankaccounts/list','sisvent/admin/bankaccounts/add','sisvent/admin/bankaccounts/edit','sisvent/admin/bankaccounts/view','sisvent/admin/paymentmethods/list','sisvent/admin/paymentmethods/add','sisvent/admin/paymentmethods/edit','sisvent/admin/payments/list','sisvent/admin/payments/add','sisvent/admin/payments/edit'])): $tesoreria_sel = 'text-white';?>
      <span class="absolute inset-y-0 left-0 w-1 bg-mam-green rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>
      <?php endif; ?>
    ...
    <li class="relative px-6 py-3">
      ...
      <transition name="fade">
        <ul v-if="isCarteraMenuOpen" class="p-2 mt-2 space-y-2 overflow-hidden text-sm font-medium text-gray-400 rounded-md" style="background:rgba(255,255,255,0.08)" aria-label="submenu">
          ...
          <?php endif; ?>
          <?php if(has_permission('estado_cuenta')): ?>
          <li class="px-2 py-1 transition-colors duration-150 hover:text-white">
  ...
  <div class="px-6 my-3">
    ...
    <?php endif; ?>
    <a href="<?php echo base_url();?>catalogo" target="_blank" class="flex items-center justify-between my-3 px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 border border-transparent rounded-lg focus:outline-none" style="background:#FF6B00;">
