                            ...
                            <table class="w-full">
                                ...
                                <tbody class="divide-y">
                                    ...
                                    <tr class="text-gray-700 text-sm">
                                        ...
                                        <td class="px-4 py-2 text-right font-medium text-green-700">$<?php echo number_format($acc->accountBalance, 2); ?></td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
                                <tfoot>
                            ...
                            <table class="w-full">
                                ...
                                <tbody class="divide-y">
                                    ...
                                    <tr class="text-gray-700 text-sm">
                                        <td class="px-4 py-2 font-mono text-xs"><?php echo $acc->accountID; ?></td>
                                        <td class="px-4 py-2"><?php echo $acc->accountName; ?></td>
                                        <td class="px-4 py-2 text-right font-medium text-red-700">$<?php echo number_format($acc->accountBalance, 2); ?></td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
                                <tfoot>
                            ...
                            <table class="w-full">
                                ...
                                <tbody class="divide-y">
                                    ...
                                    <tr class="text-gray-700 text-sm">
                                        <td class="px-4 py-2 font-mono text-xs"><?php echo $acc->accountID; ?></td>
                                        <td class="px-4 py-2"><?php echo $acc->accountName; ?></td>
                                        <td class="px-4 py-2 text-right font-medium text-orange-700">$<?php echo number_format($acc->accountBalance, 2); ?></td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
                                <tfoot>
