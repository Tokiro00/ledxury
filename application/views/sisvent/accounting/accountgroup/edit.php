                    ...
                    <form action="<?php echo base_url();?>sisvent/accounting/accountgroup/update" method="POST">
                      ...
                      <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md">
                        ...
                        <label class="block mt-4 text-sm">
                          ...
                          <select name="class_id" class="form-input form-select">
                            <?php foreach($classes as $class): ?>
                                <option value="<?php echo $class->classID?>" <?php echo set_select("class_id",$class->classID,$class->classID==$agroup->classID);?>><?php echo $class->className;?></option>
                            <?php endforeach;?>
                          </select>
                        </label>
                        ...
                        <label class="block text-sm mt-4 <?php echo !empty(form_error('description')) ? 'border-red-600':'';?>">
                          ...
                          <input class="form-input" type="text" name="description" value="<?php echo !empty(form_error('description')) ? set_value('description') : $agroup->groupDescription;?>"/>
