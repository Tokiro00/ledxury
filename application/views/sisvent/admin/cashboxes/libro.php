...
<!DOCTYPE html>
<html lang="en">
    <title>Estado de cuenta — <?php echo $cashbox->name; ?></title>
                ...
                <div class="px-6 mx-auto grid">
                    ...
                    <div class="flex items-center justify-between mb-4 mt-2">
                        <h2 class="text-lg font-semibold text-gray-600">
                            Estado de cuenta — <?php echo $cashbox->name; ?>
                            <span class="text-sm font-normal text-gray-400">(<?php echo $cashbox->code; ?>)</span>
                        </h2>
                    ...
                    <form method="get" action="<?php echo base_url(); ?>sisvent/admin/cashboxes/libro/<?php echo $cashbox->idCashbox; ?>"
                    ...
                    <div class="grid grid-cols-4 gap-4 mb-6">
                        ...
                        <div class="bg-green-50 rounded-lg shadow-sm p-4">
                            <p class="text-xs text-green-600 uppercase">Entradas</p>
                        ...
                        <div class="bg-red-50 rounded-lg shadow-sm p-4">
                            <p class="text-xs text-red-600 uppercase">Salidas</p>
