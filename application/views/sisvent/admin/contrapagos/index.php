                ...
                <div class="px-6 py-5 w-full max-w-screen-xl mx-auto">
                    ...
                    <div class="flex flex-col lg:flex-row items-start lg:items-center justify-between mb-6">
                        ...
                        <div class="flex items-center gap-3 mt-2 lg:mt-0">
                            ...
                            <a href="<?= base_url() ?>sisvent/admin/contrapagos/intercompany"
                               class="inline-flex items-center px-4 py-2 text-xs font-bold text-white rounded-lg transition-colors" style="background:#0891B2;">
                                <svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 8h6m-6 4h6m-3 4h3M5 21h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v14a2 2 0 002 2z"/></svg>
                                Cuentas MAM
                            </a>
                            <a href="<?= base_url() ?>sisvent/admin/contrapagos/invoices"
                               class="inline-flex items-center px-4 py-2 text-xs font-bold text-white rounded-lg transition-colors" style="background:#1B365D;">
                                ...
                                Facturas Interrapidísimo
                            </a>
                            <a href="<?= base_url() ?>sisvent/admin/contrapagos/despachosMam"
