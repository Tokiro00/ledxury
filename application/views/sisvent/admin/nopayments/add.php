    		...
    		<?php $this->load->view('sisvent/layouts/navbar'); ?>
    	 	<main class="h-full">
    	 		<div class="px-6 mx-auto grid">
                    ...
                    <form action="<?php echo base_url();?>sisvent/admin/nopayments/store" method="POST">
                      ...
                      <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md">
                        <label class="block mt-4 text-sm">
                          ...
                          <select id="noinvoice-id" name="invoice-id" class="form-input form-select" required>
                        ...
                        <label class="block mt-4 text-sm">
                          ...
                          <input id="vendor" class="form-input" type="text" value="" disabled/>
                        </label>
                        ...
                        <div class="flex flex-row gap-4">
                          <div class="flex-1 mt-4 text-sm col-span-12 sm:col-span-6">
                            ...
                            <input id="client" class="form-input" type="text" value="" disabled/>
                          </div>
                        </div>
