    		...
    		<?php $this->load->view('sisvent/layouts/navbar'); ?>
    	 	<main class="h-full">
    	 		<div class="px-6 mx-auto grid">
                    ...
                    <form action="<?php echo base_url();?>sisvent/admin/nopayments/update" method="POST">
                      ...
                      <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md">
                        ...
                        <label class="block mt-4 text-sm">
                          ...
                          <input id="noinvoice-id" class="form-input" type="text" value="#<?php echo str_pad($payment->invoiceId, 6, "0", STR_PAD_LEFT); ?>" disabled/>
                        </label>
                        ...
                        <label class="block mt-4 text-sm">
                          ...
                          <input id="datepicker" class="form-input font-bold" type="text" name="date" value="<?php echo date("d-m-Y", strtotime($payment->date));?>" required/>
