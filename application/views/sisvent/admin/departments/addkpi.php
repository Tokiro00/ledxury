...
<!DOCTYPE html>
<html lang="en">
    <title>Nuevo KPI - <?php echo $department->name; ?></title>
            ...
            <main class="h-full overflow-y-auto">
                <div class="px-4 py-4 w-full">
                    <div class="flex items-center justify-between mb-4">
                        <div>
                            <h2 class="text-lg font-semibold text-gray-600">Nuevo KPI</h2>
                    ...
                    <form action="<?php echo base_url(); ?>sisvent/admin/departments/addKpi/<?php echo $department->id; ?>" method="POST">
                        <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md">
                            ...
                            <label class="block text-sm mt-4">
                                ...
                                <input class="form-input" type="text" name="name"
                                       ...
                                       placeholder="Ej: Ventas del mes, Recaudo de cartera, Gastos operativos"/>
                            ...
                            <label class="block text-sm mt-4">
                                ...
                                <textarea class="form-input" name="description" rows="2"
                                          placeholder="Descripcion detallada del indicador"><?php echo set_value('description'); ?></textarea>
                            </label>
                            ...
                            <div class="grid grid-cols-3 gap-4">
                                <label class="block text-sm mt-4">
                                    ...
                                    <input class="form-input" type="number" name="target_value" step="0.01" min="0"
                                           value="<?php echo set_value('target_value'); ?>" required
                                ...
                                <label class="block text-sm mt-4">
                                    ...
                                    <select class="form-input form-select" name="unit">
                                        <option value="#" <?php echo set_select('unit', '#'); ?>>Numero (#)</option>
                                        <option value="$" <?php echo set_select('unit', '$'); ?>>Pesos ($)</option>
                                        <option value="%" <?php echo set_select('unit', '%'); ?>>Porcentaje (%)</option>
                                    </select>
                                </label>
                                <label class="block text-sm mt-4">
                                    <span class="text-gray-700">Direccion</span>
                                    <select class="form-input form-select" name="direction">
                                        <option value="higher_better" <?php echo set_select('direction', 'higher_better'); ?>>Mayor es mejor</option>
                                        <option value="lower_better" <?php echo set_select('direction', 'lower_better'); ?>>Menor es mejor</option>
                                    </select>
                                </label>
                            </div>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <label class="block text-sm mt-4">
                                    ...
                                    <input class="form-input" type="number" name="weight" step="0.1" min="0" max="100"
                                           value="<?php echo set_value('weight', '10'); ?>" required
