            ...
            <main class="h-full overflow-y-auto">
                <div class="px-4 py-4 w-full">
                    <div class="flex items-center justify-between mb-4">
                        <div>
                            <h2 class="text-lg font-semibold text-gray-600">Nuevo Departamento</h2>
                            <p class="text-xs text-gray-400">Crear un nuevo departamento</p>
                        </div>
                    ...
                    <form action="<?php echo base_url(); ?>sisvent/admin/departments/add" method="POST">
                        <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md">
                            ...
                            <label class="block text-sm mt-4">
                                ...
                                <textarea class="form-input" name="description" rows="2"
                                          placeholder="Descripcion del departamento"><?php echo set_value('description'); ?></textarea>
                            </label>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <label class="block text-sm mt-4">
                                    ...
                                    <select class="form-input form-select" name="leader_user_id">
                                        ...
                                        <option value="<?php echo $user->idUser; ?>" <?php echo set_select('leader_user_id', $user->idUser); ?>>
                                            <?php echo $user->name; ?>
                                        </option>
                                        <?php endforeach; ?>
                                    </select>
                                ...
                                <label class="block text-sm mt-4">
                                    ...
                                    <select class="form-input form-select" name="store_id">
                                        ...
                                        <option value="<?php echo $store->idStore; ?>" <?php echo set_select('store_id', $store->idStore); ?>>
                                            <?php echo $store->name; ?>
                                        </option>
                                        <?php endforeach; ?>
                                    </select>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <label class="block text-sm mt-4">
                                    ...
                                    <input class="form-input" type="number" name="budget" step="1" min="0"
                                           value="<?php echo set_value('budget', '0'); ?>" required
                                           placeholder="0"/>
