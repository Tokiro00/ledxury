                                                ...
                                                <td class="px-4 py-3">
                                                    <div class="flex items-center space-x-3">
                                                        <a href="<?php echo base_url(); ?>sisvent/admin/bankaccounts/view/<?php echo $ba->idBankAccount; ?>"
                                                           class="text-mam-blue-petroleo hover:text-mam-blue" title="Ver detalle">
                                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                        ...
                                                        <a href="<?php echo base_url(); ?>sisvent/admin/bankaccounts/libro/<?php echo $ba->idBankAccount; ?>"
                                                           class="text-mam-blue-petroleo hover:text-mam-blue" title="Estado de cuenta (libro con saldo)">
                                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
