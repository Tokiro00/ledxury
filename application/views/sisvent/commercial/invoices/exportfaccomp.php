    	 	...
    	 	<main class="h-full overflow-y-auto">
    	 		<div class="px-6 mx-auto grid">
                    <h2 class="mb-4 text-lg font-semibold text-gray-600 mt-2">
                        Crear Archivos de Facturas Compras
                    </h2>
                  ...
                  <div class="block text-sm mt-4">
                    <button id="export-faccomp-btn" class="mt-4 flex items-center justify-between px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-mam-blue-dark border border-transparent rounded-lg active:bg-mam-blue-dark hover:bg-mam-blue-dark focus:outline-none focus:shadow-outline-mam-blue-dark">
                  ...
                  <div id="export-faccomp-btn-container" class="block text-sm mt-4">
                  </div>
    	 		    </div>
	        </main>
	      </div>
