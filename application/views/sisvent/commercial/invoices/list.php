                                    ...
                                    <tr class="text-gray-700 <?php echo $key%2 ? 'bg-gray-300' : 'bg-gray-100' ?>">
                                        ...
                                        <div class="flex items-center text-sm">
                                          <div>
                                            <p class="">
                                              ...
                                              <?php endif; ?></p>
                                            <p class="text-xs text-gray-600">
                                              <?php echo (in_array($role, [1])) ? $invoice->iva.'%' : '';?>
                                            </p>
                                          </div>
                                        </div>
                                      </td>
                                      ...
                                      <td class="px-4 py-3">
                                        <div class="flex items-center space-x-4 text-sm">
                                          <button value="<?php echo $invoice->idInvoice;?>" class="btn-view-invoice flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-mam-blue-dark rounded-lg focus:outline-none focus:shadow-outline-gray" aria-label="Edit">
                                          ...
                                          <a href="<?php echo base_url()?>sisvent/commercial/invoices/payment/<?php echo $invoice->idInvoice;?>" class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-mam-blue-dark rounded-lg focus:outline-none focus:shadow-outline-gray" aria-label="Edit">
                                            <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
                                              <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z"></path>
                                            </svg>
                                          </a>
