                                    ...
                                    <tr class="text-gray-700 <?php echo $key%2 ? 'bg-gray-300' : 'bg-gray-100' ?>">
                                      ...
                                      <td class="px-4 py-3">
                                        <div class="flex items-center space-x-4 text-sm">
                                          ...
                                          <button value="<?php echo $invoice->idInvoice;?>" class="btn-payment-invoice flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-mam-blue-dark rounded-lg focus:outline-none focus:shadow-outline-gray" aria-label="Payment">
