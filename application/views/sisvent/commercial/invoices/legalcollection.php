...
defined('BASEPATH') OR exit('No direct script access allowed');
    ...
    $now = date("d-m-Y");
    $url_params = createFullParamsLinks($page, $pstore, "all", "all", "all", "all", $ps);
    $url_params_search = createFullParamsLinks($page, $pstore);
?>
<!DOCTYPE html>
<html lang="en">
    <title>Facturas Cobro Jurídico</title>
        ...
        <main class="h-full">
          <div class="px-6 mx-auto grid">
                    <h2 class="mb-4 text-lg font-semibold text-gray-600 mt-2">
                        Facturas Cobro Jurídico
                    </h2>
                    <div class="flex flex-col flex-wrap mb-8 space-y-4 md:flex-row md:items-end md:space-x-4">
                        <div class="flex-1"></div>
                      <?php if(strpos(uri_string(), 'search') !== false): ?>
                        <a href="<?php echo base_url();?>sisvent/commercial/invoices/legalcollection<?php echo $url_params_search ?>&lc=1"  class="flex items-center justify-between px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-mam-blue-petroleo border border-transparent rounded-lg active:bg-mam-blue-petroleo hover:bg-mam-blue-petroleo focus:outline-none focus:shadow-outline-mam-blue-petroleo">
                          <span>Volver</span>
                        </a>
                        <?php endif; ?>
                        <label class="block my-4 text-sm">
                          <div class="relative text-gray-500 focus-within:text-purple-600">
                            <input class="form-input-lg inline w-1/2" data-params="<?php echo $url_params_search ?>&lc=1" type="text" id="invoices-search" placeholder="Buscar factura" value="<?php echo $ps; ?>"/>
                        ...
                        <table class="w-full whitespace-no-wrap mt-8 lg:mt-0">
                          <thead>
                            <tr class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b bg-gray-50">
                              ...
                              <th class="px-4 py-3 hidden lg:table-cell">Cobrador</th>
                                ...
                                <?php foreach($invoices as $key => $invoice):?>
                                    <tr class="text-gray-700 <?php echo ($key%2 ? 'bg-gray-300' : 'bg-gray') ?> flex lg:table-row flex-row lg:flex-row flex-wrap lg:flex-no-wrap mb-10 lg:mb-0">
                                      ...
                                      <td class="px-4 py-3 text-sm whitespace-normal w-full lg:w-auto block lg:table-cell relative lg:static">
                                        <span class="lg:hidden absolute top-0 right-0 text-gray-500 uppercase border-b bg-gray-50 px-2 py-1 text-xxs font-bold">Cobrador</span>
                                      ...
                                      <td class="px-4 py-3 text-sm whitespace-normal w-full lg:w-auto block lg:table-cell relative lg:static">
                                        ...
                                        <?php echo $invoice->originalvendor_name;?>
                                      </td>
                                      ...
                                      <td class="px-4 py-3 w-full lg:w-auto block lg:table-cell relative lg:static">
                                        ...
                                        <div class="flex items-center space-x-4 text-sm">
                                          ...
                                          <a href="<?php echo base_url()?>sisvent/commercial/invoices/edit/<?php echo $invoice->idInvoice.$url_params;?>&lc=1" class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-mam-blue-petroleo rounded-lg focus:outline-none focus:shadow-outline-gray" aria-label="Edit">
                                          ...
                                          <?php if(in_array($role, [1])): ?>
                                            <a href="<?php echo base_url()?>sisvent/commercial/invoices/refund/<?php echo $invoice->idInvoice.$url_params;?>&lc=1" class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-mam-blue-petroleo rounded-lg focus:outline-none focus:shadow-outline-gray" aria-label="Refund">
                                            ...
                                            <button value="<?php echo $invoice->idInvoice;?>"  data-params="<?php echo $url_params ?>&lc=1" class="btn-payment-invoice flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-mam-blue-petroleo rounded-lg focus:outline-none focus:shadow-outline-gray" aria-label="Payment">
                                          ...
                                          <?php endif; ?>
                                          <?php if(in_array($role, [1])): ?>
                                          <a href="<?php echo base_url()?>sisvent/commercial/invoices/delete/<?php echo $invoice->idInvoice;?>?lc=1" class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-mam-blue-petroleo rounded-lg focus:outline-none focus:shadow-outline-gray" onclick="showSureModal(event,this)" aria-label="Delete">
                                            <p class="tooltip"><svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
