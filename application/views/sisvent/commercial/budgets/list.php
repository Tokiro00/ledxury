    	 	...
    	 	<main class="h-full">
    	 		<div class="px-6 mx-auto grid">
                    ...
                    <div class="flex flex-col flex-wrap mb-8 space-y-4 md:flex-row md:items-end md:space-x-4">
                        ...
                        <?php if(in_array($role, [1])): ?>
                          <a href="<?php echo base_url();?>sisvent/commercial/budgets/createExcel"  class="flex items-center justify-between px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-mam-blue-dark border border-transparent rounded-lg active:bg-mam-blue-dark hover:bg-mam-blue-dark focus:outline-none focus:shadow-outline-mam-blue-dark">
                            <span>Excel</span>
