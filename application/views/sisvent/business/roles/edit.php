    	 	...
    	 	<main class="h-full">
    	 		<div class="px-4 py-4 w-full">
                    <h2 class="mb-4 text-lg font-semibold text-gray-600 mt-2">
                        Editar Rol: <?php echo htmlspecialchars($role->name);?>
                    </h2>

                    <form action="<?php echo base_url();?>sisvent/business/roles/update/<?php echo $role->idRoles;?>" method="POST">
                      ...
                      <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md max-w-2xl">
                        ...
                        <label class="block text-sm mt-4 <?php echo !empty(form_error('name')) ? 'border-red-600':'';?>">
                          ...
                          <input class="form-input" type="text" name="name" value="<?php echo set_value('name', $role->name);?>" required/>
                        ...
                        <label class="block text-sm mt-4 <?php echo !empty(form_error('description')) ? 'border-red-600':'';?>">
                          ...
                          <input class="form-input" type="text" name="description" value="<?php echo set_value('description', $role->description);?>"/>
                        ...
                        <label class="block text-sm mt-4 <?php echo !empty(form_error('puc_code')) ? 'border-red-600':'';?>">
                          ...
                          <input class="form-input" type="text" name="puc_code" value="<?php echo set_value('puc_code', $role->puc_code);?>"/>
