    	 	...
    	 	<main class="h-full">
              ...
              <div class="flex flex-col flex-wrap mb-8 space-y-4 md:flex-row md:items-end md:space-x-4">
                  <?php if(in_array($role, [1,2])): ?>
                      <a href="<?php echo base_url();?>sisvent/business/vendors/add"  class="flex items-center justify-between px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-mam-blue-dark border border-transparent rounded-lg active:bg-mam-blue-dark hover:bg-mam-blue-dark focus:outline-none focus:shadow-outline-mam-blue-dark">
                                ...
                                <td class="px-4 py-3">
                                  <div class="flex items-center space-x-4 text-sm">
                                    ...
                                    <?php if($user->idUser !="00000"): ?>
                                      <a href="<?php echo base_url()?>sisvent/business/vendors/archive/<?php echo $user->idUser;?>" class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-mam-blue-dark rounded-lg focus:outline-none focus:shadow-outline-gray" aria-label="Archive">
