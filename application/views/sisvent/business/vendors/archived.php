    		...
    		<?php $this->load->view('sisvent/layouts/navbar'); ?>
    	 	<main class="h-full">
              ...
              <div class="flex items-center gap-2 mb-4 border-b pb-3">
                  ...
                  <a href="<?= base_url() ?>sisvent/business/vendors/archived" class="px-4 py-2 text-sm font-semibold text-white rounded-lg" style="background:#1B365D;">Archivados</a>
              </div>
                                ...
                                <td class="px-4 py-3">
                                  <div class="flex items-center space-x-4 text-sm">
                                    ...
                                    <?php if($user->idUser !="00000"): ?>
                                      <a href="<?php echo base_url()?>sisvent/business/vendors/unarchive/<?php echo $user->idUser;?>" class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-mam-blue-petroleo rounded-lg focus:outline-none focus:shadow-outline-gray" aria-label="Archive">
