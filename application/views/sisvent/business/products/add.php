                    ...
                    <form action="<?php echo base_url();?>sisvent/business/products/store" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md">
                        ...
                        <label class="flex items-center mt-4 dark:text-gray-400">
                          <input type="checkbox" name="not_settle" class="text-mam-blue-petroleo form-checkbox focus:border-mam-blue-petroleo focus:outline-none focus:shadow-outline-mam-blue-petroleo" />
                          <span class="ml-2"><b>No</b> liquidar producto</span>
                        </label>

                        <label class="flex items-center mt-4 dark:text-gray-400">
                          <input type="checkbox" name="is_national" class="text-mam-blue-petroleo form-checkbox focus:border-mam-blue-petroleo focus:outline-none focus:shadow-outline-mam-blue-petroleo" />
