    		...
    		<?php $this->load->view('sisvent/layouts/navbar'); ?>
    	 	<main class="h-full overflow-y-auto">
    	 		<div class="px-6 mx-auto grid">
                    ...
                    <form action="<?php echo base_url();?>sisvent/business/providers/update" method="POST">
                      ...
                      <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md">
                        <input class="form-input" type="hidden" name="id" value="<?php echo $provider->idProvider;?>" readonly/>
                        ...
                        <label class="block text-sm mt-4 <?php echo !empty(form_error('provider_id')) ? 'border-red-600':'';?>">
                          ...
                          <input class="form-input" type="text" name="provider_id" value="<?php echo $provider->idNum;?>"/>
                        ...
                        <label class="block text-sm mt-4 <?php echo !empty(form_error('name')) ? 'border-red-600':'';?>">
                          ...
                          <input class="form-input" type="text" name="name" value="<?php echo !empty(form_error('name')) ? set_value('name') : $provider->name;?>" required/>
                        ...
                        <label class="block text-sm mt-4 <?php echo !empty(form_error('address')) ? 'border-red-600':'';?>">
                          ...
                          <input class="form-input" type="text" name="address" value="<?php echo !empty(form_error('address')) ? set_value('address') : $provider->address;?>"/>
                        ...
                        <label class="block text-sm mt-4 <?php echo !empty(form_error('phone')) ? 'border-red-600':'';?>">
                          ...
                          <input class="form-input" type="text" name="phone" value="<?php echo !empty(form_error('phone')) ? set_value('phone') : $provider->phone;?>"/>
                        ...
                        <label class="block text-sm mt-4 <?php echo !empty(form_error('email')) ? 'border-red-600':'';?>">
                          ...
                          <input class="form-input" type="email" value="<?php echo !empty(form_error('email')) ? set_value('email') : $provider->email;?>" name="email"/>
