                      ...
                      <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md">
                        ...
                        <label class="block text-sm mt-4">
                          ...
                          <select class="form-input form-select mt-1" name="puc_code">
                            <option value="220501" selected>220501 — Proveedores Nacionales</option>
                            <option value="221001">221001 — Proveedores del Exterior (China)</option>
                            <option value="231001">231001 — Socios / Accionistas</option>
                            <option value="210510">210510 — Obligaciones Bancarias</option>
                          </select>
