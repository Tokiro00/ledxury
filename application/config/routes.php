...
$route['ventas/devoluciones'] = 'ventas/Ventas/devoluciones';
...
$route['api/v1/credit-notes/create'] = 'api/V1/credit_notes_create';
$route['api/v1/client-invoices'] = 'api/V1/client_invoices';
